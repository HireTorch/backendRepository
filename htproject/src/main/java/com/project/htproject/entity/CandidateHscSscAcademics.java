...
public class CandidateHscSscAcademics {
	...
	public CandidateHscSscAcademics(Integer academicsId, String schoolName, int obtainedMarks, int totalMarks,
	...
	public Integer getAcademicsId() {
		return academicsId;
	}

	public void setAcademicsId(Integer academicsId) {
		this.academicsId = academicsId;
	}
